...
#define STRING_CONFIG_H_AUTHOR "(mmes, SV01-SKR-mini-E3-V2.0-BL)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SV01-SKR-mini-E3-V2.0"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, -0, 4.0 }
